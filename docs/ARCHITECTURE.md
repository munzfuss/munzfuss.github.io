...
> **Canonical decisions journal: [`V2_DECISIONS.md`](V2_DECISIONS.md).** Every architectural decision (31 + 4 deferred) listed with rationale + code locations. Read that file first to understand WHY the pipeline is shaped this way; the section below describes WHAT it is.
>
