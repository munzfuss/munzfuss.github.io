...
**Cross-references:**
  ...
  - **`docs/research/moentordning_1541.md`** (created 2026-05-15) — focused single-ordinance dossier for the 1541 + 1544 ordinances themselves. Synthesises Galster + Wilcke + Kroman, attests parameters from Hede c3h cache empirically, names the verbatim-text retrieval path (Rosenvinge 1824 Vol. IV / Rigsarkivet Danske Kancelli). §8 of this dossier maps directly to the §BC sub-task list (proposed `christian_iii_dalerfod` Fuß with mf 8.827 etc.).
