...
### BV. 🔵 Pre-1582 Danish Müntzfüße — define missing standards in fuesse.yml + Denmark page  *(opened 2026-05-20, user-marked «найвищий», **6 of 8 closed 2026-05-21**, status: In review)* *(est: medium-large)* *(type: data + research-applied)*

**Progress 2026-05-21 — 6 of 8 candidates closed, ticket in In review:**
