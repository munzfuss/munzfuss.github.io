...
|---|---|---|---|---|
| `schleswig_holstein.yml` | 299 | 26 across 7 Münzfüße | 1567 – 1863 | `schleswig_holstein-references.yml` (26 entries) |
...
├── locations/
│   ├── schleswig_holstein.yml           Per-location: phases + coins + inline DE/EN/UK
